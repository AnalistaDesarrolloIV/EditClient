                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control @error('Nombre_Direccion') is-invalid @enderror" id="floatingInput" placeholder="name@example.com" value="{{$dire['Nombre_Direccion']}}" name="FACTURA" >
                                    <label for="floatingInput">Nombre Dirección.</label>
                                </div>
                            ...
                            <div class="col-6">
                                <div class="form-floating mb-3">
                                    ...
                                    <label for="direccion_completa">Dirección fisica.</label>
                                </div>
                            </div>
                            ...
                            <div class="col-6">
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" id="floatingInput" placeholder="name@example.com" value="{{$dire['Ciudad']}}" name="Ciudad" >
                                    <label for="floatingInput">Ciudad.</label>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" id="floatingInput" placeholder="name@example.com" value="{{$dire['Barrio_Vereda_Corregimiento']}}" name="Barrio_Vereda_Corregimiento">
                            ...
                            <div class="col-12">
                                <div class="form-floating mb-3">
                                    <select class="form-select" id="floatingSelectGrid" name="Codigo_Postal">
                                        <option value="1">250030-Madrid, Cundinamarca</option>
                                        <option value="2">250030-Madrid, Cundinamarca</option>
                                    </select>
                                    <label for="floatingSelectGrid">Codigo postal.</label>
                                </div>
                            </div>
                            <!-- <div class="col-12">
                                <div class="form-floating mb-3">
                            ...
                            <div class="col-12">
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" id="floatingInput" placeholder="name@example.com" value="{{$_SESSION['USER']}}" name="Identificacion">
                                    <label for="floatingInput">Numero de documento. <b style="font-size: 18px; color: red;">*</b></label>
                                </div>
                            </div>
                        </div>
