        ...
        <div class="container-fluid mt-5"> 
            <div class="row justify-center align-items-center ">
                <div class="col-md-10 col-12">
                    <div class="row op rounded p-4 pt-3" id="content">
                        <div class="col-12">
                            <div class="row">
                            ...
                            <form action="{{route('editPersonal')}}" method="post" enctype="multipart/form-data" id="form_person">
                                ...
                                <div class="row d-flex justify-content-end my-2">
                                    <div class="col-12 col-md-4 pb-3 pb-md-0 d-grid gap-2">
                                        <button type="button" class="btn btn-dark text-white" id="Edit_person">Editar y siguiente <i class="fas fa-angle-double-right"></i></button>
                                    </div>
                                </div>
                            </form>
                        </div>
...
@section('script')
    ...
    <script>
        ...
        $("#Edit_person").click(function () {
            ...
            role="status" aria-hidden="true"></span> Editar y siguiente <i class="fas fa-angle-double-right">`
            ) ;
        });
