                                ...
                                <form action="{{ route('info.store') }}" method="post">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-floating mb-3">
                                            <select class="form-select" id="floatingSelectGrid" name="tipoIdentificacion">
                                        ...
                                        <div class="col-12">
                                            <div class="form-floating mb-3">
                                                <input type="text" class="form-control" id="floatingInput" placeholder="name@example.com" name="identificacion" required>
                                    ...
                                    <div class="row d-flex justify-content-end mb-5">
                                        <div class="col-12 col-md-4 pb-3 pb-md-0 d-grid gap-2">
                                            <button type="submit" class="btn btn-dark text-white">Buscar</button>
                                        </div>
                                        <div class="col-12 col-md-4 pb-3 pb-md-0 d-grid gap-2">
