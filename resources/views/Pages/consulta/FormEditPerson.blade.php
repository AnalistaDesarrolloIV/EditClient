                ...
                <div class="col">
                    ...
                    <form action="npersonaledit" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="form-floating mb-3">
                                    <input type="email" class="form-control" id="floatingInput" placeholder="name@example.com" value="{{$usuario['EmailAddress']}}" name="EmailAddress" required>
                                    <label for="floatingInput">Correo personal. <b style="font-size: 18px; color: red;">*</b></label>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" id="floatingInput" placeholder="name@example.com" value="{{$usuario['EmailAddress']}}" name="EmailAddress2" required>
                            ...
                            <div class="col-12">
                                <!-- <div class=" mb-3"> -->
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="file" class="form-control d-flex align-content-center" id="inputGroupFile01" name="IdentificacionArch" style="height: 3.5rem;" accept=".pdf" >
                                    </div>
                                <!-- </div> -->
                            </div>
                            @else
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="file" class="form-control d-flex align-content-center" id="inputGroupFile01" name="IdentificacionArch" style="height: 3.5rem;" accept=".pdf" required>
                                    </div>
                            @endif
                            <!-- <div class="col-12">
                                <div class="form-floating mb-3">
